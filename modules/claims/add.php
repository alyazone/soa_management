...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($vehicle_type_err) && empty($entries_err)){
        try {
            ...
            $sql = "INSERT INTO claims (staff_id, claim_month, vehicle_type, description, amount, status, km_rate, total_km_amount, employee_signature, signature_date) 
                    VALUES (:staff_id, :claim_month, :vehicle_type, :description, :amount, 'Pending', :km_rate, :total_km_amount, 1, CURDATE())";
...
<div class="col-md-10 ml-sm-auto px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Submit Mileage Reimbursement Claim</h1>
