           ...
           <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
               ...
               <div class="card mb-4">
                   <div class="card-header bg-light">
                       ...
                       <small class="text-muted">Basic information about the supplier company</small>
                   </div>
                   <div class="card-body">
                       <div class="form-group">
                           ...
                           <div class="input-group">
                               ...
                               <input type="text" name="supplier_name" class="form-control <?php echo (!empty($supplier_name_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $supplier_name; ?>" placeholder="Enter company name">
                               <span class="invalid-feedback"><?php echo $supplier_name_err; ?></span>
                           </div>
                           <small class="form-text text-muted">Enter the official registered name of the supplier</small>
                       </div>
                       ...
                       <div class="form-group">
                           ...
                           <small class="form-text text-muted">Include street address, city, state, and postal code</small>
                       </div>
                   </div>
               </div>
               ...
               <div class="card mb-4">
                   <div class="card-header bg-light">
                       ...
                       <small class="text-muted">Information about the primary contact person</small>
                   </div>
                   <div class="card-body">
                       <div class="form-group">
                           <label>
                           ...
                           <div class="input-group">
                               ...
                               <input type="text" name="pic_name" class="form-control <?php echo (!empty($pic_name_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $pic_name; ?>" placeholder="Enter contact person's name">
                               <span class="invalid-feedback"><?php echo $pic_name_err; ?></span>
                           </div>
                           <small class="form-text text-muted">Person In Charge (PIC) for this supplier</small>
                       </div>
                       ...
                       <div class="form-row">
                           <div class="form-group col-md-6">
                               ...
                               <small class="form-text text-muted">Include country and area code if applicable</small>
                           </div>
                           ...
                           <div class="form-group col-md-6">
                               ...
                               <small class="form-text text-muted">Business email address for official communications</small>
                           </div>
                       </div>
                   </div>
               </div>
