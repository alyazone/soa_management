...
try {
    ...
    die("ERROR: Could not fetch supplier. " . $e->getMessage());
}

// Fetch SOAs related to this supplier
try {
...
// Fetch documents related to this supplier
try {
...
<div class="col-md-10 ml-sm-auto px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="edit.php?id=<?php echo $supplier['supplier_id']; ?>" class="btn btn-sm btn-primary mr-2">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>PIC Name</th>
                                <td><?php echo htmlspecialchars($supplier['pic_name']); ?></td>
                            </tr>
                            <tr>
                                <th>PIC Contact</th>
                                <td><?php echo htmlspecialchars($supplier['pic_contact']); ?></td>
                            </tr>
                            <tr>
                                <th>PIC Email</th>
                                <td><?php echo htmlspecialchars($supplier['pic_email']); ?></td>
                            </tr>
                            <tr>
                                <th>Created At</th>
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo $basePath; ?>modules/soa/add.php?supplier_id=<?php echo $supplier['supplier_id']; ?>" class="btn btn-sm btn-primary">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <p>No SOAs found for this supplier.</p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Supplier Statistics</h6>
                </div>
                <div class="card-body">
                    <?php
