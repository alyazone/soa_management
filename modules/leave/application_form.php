...
try {
    $staffs = $pdo->query("SELECT staff_id, full_name, department FROM staff ORDER BY full_name")->fetchAll();
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select name="staff_id" id="staff_id" class="form-input" required>
                                    <option value="" department="N/A">-- Select Staff --</option>
                            ...
                            <?php if(isset($errors['staff_id'])): ?><span class="error-message"><i class="fas fa-exclamation-circle"></i> <?php echo $errors['staff_id']; ?></span><?php endif; ?>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Department</label>
                                <input type="text" class="form-input" id="department_input" value="N/A" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select name="leave_reason" id="leave_reason" class="form-input" required>
                                    ...
                                    <option value="CPL">Compassionate Paternal Leave</option>
                                    <option value="CML">Compassionate Maternal Leave</option>
