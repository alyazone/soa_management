<div class="modern-sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-list">
            ...
            <!-- 3. Client Management -->
            <?php $clientActive = (strpos($_SERVER['PHP_SELF'], '/modules/clients/') !== false || strpos($_SERVER['PHP_SELF'], '/modules/soa/client') !== false); ?>
            <li class="nav-item has-submenu">
                <a href="#" class="nav-link <?php echo $clientActive ? 'active' : ''; ?>" data-toggle="submenu">
                    <i class="fas fa-building"></i>
                    <span>Client Management</span>
                    <i class="fas fa-chevron-right submenu-arrow"></i>
                </a>
                <ul class="submenu <?php echo $clientActive ? 'show' : ''; ?>">
                    <li>
            ...
            <?php $supplierActive = (strpos($_SERVER['PHP_SELF'], '/modules/suppliers/') !== false || strpos($_SERVER['PHP_SELF'], '/modules/soa/supplier') !== false || strpos($_SERVER['PHP_SELF'], '/modules/purchase_orders/') !== false); ?>
            <li class="nav-item has-submenu">
                <a href="#" class="nav-link <?php echo $supplierActive ? 'active' : ''; ?>" data-toggle="submenu">
